...
DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://dsbro:dsbro@cluster0.gtu48kz.mongodb.net/?retryWrites=true&w=majority") 
...
UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "MM_MOVIESSS") # For Force Subscription
